...
import { useGetProductList } from '@org/hooks';
...
export const ProductList = () => {
  ...
  const [expandedRows, setExpandedRows] = useState<Record<
    number,
    boolean
  > | null>(null);
  ...
  useEffect(() => {
    if (error) {
      addToast(
        t('common:messages.error', { name: t('product:product.title') }),
        'error',
        3000
      );
    }
  ...
  return (
    <div className="container">
      ...
      >
        <Column
          field="title"
          header={t('product:table.title')}
          sortable
          headerStyle={{ textAlign: 'center' }}
        ></Column>
        <Column
          field="thumbnail"
          header={t('product:table.image')}
        ...
        ></Column>
        <Column
          header={t('product:table.actions')}
